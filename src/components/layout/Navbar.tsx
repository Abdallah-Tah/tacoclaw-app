...
import { LayoutDashboard, UserCircle, Activity, Menu, X } from 'lucide-react';
  ...
  return (
    <nav className="h-16 glass border-b-0 sticky top-0 z-50 px-4 sm:px-6 flex items-center justify-between shadow-[0_4px_30px_rgba(0,0,0,0.3)]">
      ...
      <div className="flex items-center gap-4">
        {/* System Status - Hidden on very small screens, compact on mobile */}
      ...
      {isMobileMenuOpen && (
        <div className="absolute top-16 left-0 right-0 glass border-t border-taco-border p-4 md:hidden animate-in slide-in-from-top-4 duration-300">
          <div className="flex flex-col gap-2">
            ...
            <div className="mt-2 pt-4 border-t border-taco-border flex justify-center">
